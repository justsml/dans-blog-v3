...
import { Challenge, Question, Options, Option, Explain, Hint, Hints, QuizUI} from '@/components/QuizUI';
...
1. **Check for Hints** (Green button, lower left corner).
...
<Challenge group="Handling Errors" title="Multiple `.catch`'s #1">
  <Question>
  ...
  <Options>
    <Option>print message once</Option>
    <Option answer={true}>print message twice</Option>
    <Option>UnhandledPromiseRejectionWarning</Option>
    <Option>process exits</Option>
  </Options>
  <Explain>

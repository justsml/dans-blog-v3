...
import Explanation from '../../../components/QuizUI/Explanation';

import cover from './w900_olav-ahrens-rotne-jvBXiynINGE-resized.png';

# Do you know JavaScript Promises?

<Image
  src={cover}
  alt="JavaScript Promises Quiz"
  widths={[300, 600, 900]}
  sizes="(max-width: 600px) 100vw, 600px"
  height="auto"
  style="border-radius: 100%; margin: 1rem auto; "
/>

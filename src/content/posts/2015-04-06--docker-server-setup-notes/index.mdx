...
<a href="#postgres-server"><img src="./postgresql.svg" class="svg-icon" /> Postgres</a>
<a href="#mongodb-server"><img src="./mongodb.svg" class="svg-icon" /> MongoDB</a>
<a href="#mysql-server"><img src="./mysql.svg" class="svg-icon" /> MySQL</a>
<a href="#elasticsearch-server"><img src="./elastic.svg" class="svg-icon" /> ElasticSearch</a>

...
import {getImageProps} from '../../../shared/dataCache';

## How To Become an Open Source Millionaire*

- Drippin' in donations? 💰
- Rollin' in repos? 🏎️
- Rebasin' [Robb Report](https://robbreport.com/)? 🤯

> In only 3 simple steps* I'll show you how to leverage any _recent_ experience into a meaningful PR for the libraries you rely on! ✨, plus a few decades of experience, and unflinching dedication, .


<Image src={getImageProps(frontmatter.cover)} alt="OSS High Life" class="circular-radius" />
